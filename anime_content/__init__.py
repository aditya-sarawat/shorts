import os
import random
from anime_content.anime_video import get_video_by_anime, get_random_animated_video
from anime_content.quote_generator import get_combined_quote
from anime_content.video_processor import download_video, apply_blur_to_video, crop_video, process_cropped_video

fonts_folder = "./fonts"
hindi_fonts_folder = os.path.join(fonts_folder, "hindi")
english_fonts_folder = os.path.join(fonts_folder, "english")

BASE_DIR = "./anime_content/__temp__"
...
def generate_motivational_content():
    ...
    if quote_info:
        ...
        video_url = get_video_by_anime(tags)
        ...
        if video_url:
            ...
            if download_video(video_url):
                ...
                process_cropped_video(BLURRED_VIDEO_PATH, quote, selected_font)
